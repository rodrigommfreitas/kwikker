...
export const KweekUtils = ({ reply }: Props) => {
  if (reply)
    return (
      <div className="flex h-fit items-center gap-1 text-blue-light">
        ...
        <button
          className="hidden rounded-full p-2 transition disabled:text-blue-light/50 sm:flex"
          disabled
        >
